...
These diagrams describe the current implementation and are the canonical
architecture evidence for the Final Demo.

- [System context](system-context.md): users, system boundary, and external dependencies.
...
The reasoning behind the architecture is recorded in
[Design Justification](../design-justification.md) and the individual ADRs.
