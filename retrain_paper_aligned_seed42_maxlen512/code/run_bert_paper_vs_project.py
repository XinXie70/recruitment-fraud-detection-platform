...
Paper protocol (Jonathan et al., ICITCOM 2025 style):
  ...
  - seed = 42
  - bert-base-uncased, max_length=512, lr=5e-5, effective batch=16, epochs=3
...
ASSIGNMENT_FILE = PROJECT_ROOT / "data" / "splits" / "assignments.csv.gz"
WEIGHTS_DIR = PROJECT_ROOT / "weights"
RESULTS_DIR = PROJECT_ROOT / "results"
FIGURES_DIR = RESULTS_DIR / "figures"
SEED = 42
RUN_NAME = "bert_paper_protocol_maxlen512"
...
def parse_args() -> argparse.Namespace:
    ...
    # max_length=512 on 6GB GPU: keep effective batch=16 via accum
...
def main() -> None:
    ...
    cfg = BertFinetuneConfig(
        ...
        min_fraud_recall_for_threshold=None,  # unconstrained
        threshold_selection_mode="max_fbeta",  # precision-leaning, not hard-coded thr
        threshold_f_beta=0.5,
        threshold_step=0.01,
