"""Logistic Regression inference: binary probability + risk mapping post-processing."""
...
def predict_job_posting(input_text: str) -> dict:
    ...
    Flow: LR binary classification → risk_score → risk mapping layer → structured JSON
    """
