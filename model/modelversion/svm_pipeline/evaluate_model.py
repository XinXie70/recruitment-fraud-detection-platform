"""SVM evaluation: dual-threshold tuning, three-tier risk stats, visualization."""
...
from final_model_pipelines.svm_pipeline.data_preprocessing import load_or_create_splits, transform_text  # noqa: E402
...
from final_model_pipelines.svm_pipeline.predict import predict_job_posting  # noqa: E402


def evaluate() -> dict:
    model_path = SAVED_MODEL_DIR / "model.joblib"
    if not model_path.exists():
        raise FileNotFoundError("SVM model not found. Run train_model.py first.")
