"""RoBERTa inference: binary probability + risk mapping post-processing."""
...
from final_model_pipelines.roberta_pipeline.data_preprocessing import prepare_text_from_input  # noqa: E402
...
def _predict_risk_score(texts: list[str]) -> np.ndarray:
    """Raw binary RoBERTa output: fake job probability (softmax[:, 1]) as risk_score."""
