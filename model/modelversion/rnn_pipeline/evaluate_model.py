"""RNN evaluation: dual-threshold tuning, three-tier risk stats, visualization."""
...
from final_model_pipelines.rnn_pipeline.predict import predict_job_posting  # noqa: E402


def evaluate() -> dict:
    model_path = SAVED_MODEL_DIR / "model.keras"
    if not model_path.exists():
        raise FileNotFoundError("RNN model not found. Run train_model.py first.")
