"""RNN pipeline data preprocessing (delegates to shared modules; self-contained training pipeline)."""
...
from final_model_pipelines.rnn_pipeline.model_config import MAX_LEN, MAX_LEN_PERCENTILE, MAX_VOCAB
